...
import com.example.board.socket.CustomChannelInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        // 간단한 메모리 기반 메시지 브로커를 활성화하고, "/room"으로 시작하는 목적지의 메시지들이 이 브로커를 통해 구독자에게 전달되도록 설정합니다.
    ...
    // 클라이언트가 서버에게 보내는 모든 메시지를 처리하기 위한 설정을 정의합니다.
    @Override
